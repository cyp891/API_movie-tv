const global = {
  ...
  api: {
    API_KEY: "3df058c55613818b714376e02f35bb00",
...
async function displayPopularMovies() {
  ...
  results.forEach((movie) => {
    ...
    `;
    document.querySelector("#popular-movies").appendChild(movieElem);
  });
}
...
async function displayPopularShows() {
  ...
  results.forEach((show) => {
    ...
    `;
    document.querySelector("#popular-shows").appendChild(showElem);
  });
}
...
async function search() {
  ...
  if (global.search.term != "" && global.search.term != null) {
    ...
    showAlert("Please do something because the input is invalid");
  }
}
...
function displaySearchResults(results) {
  ...
  results.forEach((result) => {
    ...
    `;
    document.querySelector("#search-results").appendChild(movieElem);
  });
  displayPaginations();
}

function displayPaginations() {
  const div = document.createElement("div");
